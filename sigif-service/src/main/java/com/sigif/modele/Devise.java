...
/**
 * Entité représentant la table devise.
 */
@Entity
@Table(name = "devise", uniqueConstraints = @UniqueConstraint(columnNames = "code"))
public class Devise extends AbstractModele implements java.io.Serializable {

    private static final long serialVersionUID = 3714809457616780663L;
    ...
    public Devise(String code, String designation, Statut statut, Date dateCreation, Date dateModification) {
        this.code = code;
