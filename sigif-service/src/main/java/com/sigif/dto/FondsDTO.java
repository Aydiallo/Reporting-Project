...
/**
 * DTO de la table Fonds.
 * 
 * @author Meissa Beye
 * @since 02/05/2017
 *
 */
public class FondsDTO extends AbstractDTO implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -1973477970200864851L;

	private TypeFondsDTO typeFonds;
	...
	public TypeFondsDTO getTypeFonds() {
		return typeFonds;
	}

	public void setTypeFonds(TypeFondsDTO typeFonds) {
