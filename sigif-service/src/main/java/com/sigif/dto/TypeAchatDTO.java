...
/**
 * DTO de la table Type d'Achat.
 * 
 * @author Meissa Beye
 * @since 16/06/2017
 *
 */
public class TypeAchatDTO extends AbstractDTO implements Serializable {
	/**
	* 
	*/
	private static final long serialVersionUID = 6603044819680463728L;
